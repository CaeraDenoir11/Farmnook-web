				...
				<div className="py-8">
					...
					<div className="my-4 flex items-center gap-4 w-full">
						<select
							...
							className="border border-gray-300 px-4 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1A4D2E] focus:border-transparent transition-colors duration-200 cursor-pointer"
						>
