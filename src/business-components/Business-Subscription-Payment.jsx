...
export default function BusinessSubscriptionPayment() {
  ...
  return (
    <div className="flex min-h-screen">
      <div className="flex-1">
        <div className="flex items-center justify-center min-h-screen  text-black text-left">
          <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-2xl relative">
            ...
            <div className="grid grid-cols-2 gap-6 mt-4 ">
              ...
              <div>
                ...
                <label className="block text-sm font-medium mt-4 text-left">
                  Country
                </label>
                ...
                <label className="block text-sm font-medium mt-2 text-left">
                  Zip Code
                </label>
                <input
                  type="text"
              ...
              <div className="flex flex-col justify-between">
                ...
                <div className="border p-4 rounded-md">
                  ...
                  <label className="flex items-center space-x-3 mt-3 border p-2 rounded-md cursor-pointer bg-blue-100">
                    <input
                      ...
                      onChange={() => setSubscription("annual")}
                      className="form-radio"
                    />
                    <div>
                      <p className="font-medium">
                        Pay Annually{" "}
                        <span className="text-blue-500 text-xs">Save 20%</span>
                      </p>
                      <p className="text-sm text-gray-500">
                        ₱18 / Month Per Member
                      </p>
                ...
                <button
                  ...
                  className="w-full bg-indigo-900 text-white py-2 rounded-md hover:bg-blue-700"
                >
                  ⚡ Proceed
                </button>
              </div>
